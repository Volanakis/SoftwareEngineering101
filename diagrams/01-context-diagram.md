...
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'fontFamily':'Segoe UI, sans-serif', 'background':'#ffffff', 'primaryColor':'#eef2ff', 'primaryBorderColor':'#4338ca', 'primaryTextColor':'#1e1b4b', 'lineColor':'#6366f1'}}}%%
flowchart LR
