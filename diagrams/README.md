...
- [📌 0. Παραδοχές που επιλύουν ασάφειες του εκφωνήματος](#0-παραδοχές-που-επιλύουν-ασάφειες-του-εκφωνήματος)
- [🗺️ 1. Σύνοψη διαγραμμάτων & Κάλυψη Use Cases](#1-σύνοψη-διαγραμμάτων--κάλυψη-use-cases)
- [🏗️ 2. Αρχιτεκτονική & Πλαίσιο Συστήματος](#2-αρχιτεκτονική--πλαίσιο-συστήματος)
- [🧭 3. Use Cases](#3-use-cases)
- [🔄 4. Συμπεριφορά Συστήματος](#4-συμπεριφορά-συστήματος)
- [🧩 5. Οντότητες Συστήματος](#5-οντότητες-συστήματος)
- [✏️ 6. Πώς να ανοίξετε/επεξεργαστείτε τα διαγράμματα](#6-πώς-να-ανοίξετεεπεξεργαστείτε-τα-διαγράμματα)
